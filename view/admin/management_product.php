                                        ...
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline d-flex justify-content-between">
                                                ...
                                                <div class="form-group mr-2">
                                                    <button id="demo-btn-addrow" class="btn btn-primary"><i class="mdi mdi-plus-circle mr-2"></i> Thêm mới sản phẩm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="demo-delete-row btn btn-warning btn-sm btn-icon">Sửa</button>
                                                    <button class="demo-delete-row btn btn-danger btn-sm btn-icon">Xóa</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Shona</td>
